...
(23, 'ODA', 'Official Development Assistance');
...
--
ALTER TABLE `agency`
  MODIFY `AgencyID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;

--
-- AUTO_INCREMENT for table `funding_src`
--
ALTER TABLE `funding_src`
  MODIFY `FSID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `prog_proj_status`
  MODIFY `Code` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80;

--
-- AUTO_INCREMENT for table `project_chapter`
--
ALTER TABLE `project_chapter`
  MODIFY `Code` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;
